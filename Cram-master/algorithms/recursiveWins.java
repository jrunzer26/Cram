...
public class recursiveWins extends Algo{ // Replace TeamName
    private static String teamName = "recursiveWins"; // Replace TeamName
    ...
    public static void main(String[] args){
        ...
        game.startGame(recursiveWins.class); // Replace TeamName
    }
